...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    // Route-specific pages own canonical/hreflang metadata. Keeping homepage
    // alternates here would incorrectly add homepage hreflang URLs to every
    // guide, wiki and article page.
    links: [
      {
        rel: 'icon',
        href: '/favicon.png',
